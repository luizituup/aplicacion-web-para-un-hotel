                                            ...
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <div>
                                                        <ul class="menu">
                                                            <li class="top">
                                                                <a href="<%=request.getContextPath()%>/Administrador.jsp" class="top_link"><span>Inicio</span></a></li>
                                                            <li class="top">
                                                                <a href="#" class="top_link"><span>Cliente</span></a>
                                                                <ul class="sub">
                                                                    <li><a href="<%=request.getContextPath()%>/RegistrarCliente.jsp" target="Content" title="ResgistrarC">Registrar</a></li>
                                                                    <li><a href="<%=request.getContextPath()%>/ListarCliente.jsp" target="Content" title="ListarC">Listar</a></li>
                                                                    <li><a href="<%=request.getContextPath()%>/ConsultarCliente.jsp" target="Content" title="COnsultarC">Consultar</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="top">
                                                            ...
                                                            <li class="top">
                                                                <a href="#" class="top_link"><span>Servicios</span></a>
                                                                <ul class="sub">
                                                                    <li><a href="<%=request.getContextPath()%>/RegistrarServicos.jsp" target="Content" title="RegistrarS">Registrar</a></li>
                                                                    <li><a href="<%=request.getContextPath()%>/ListaServicios.jsp" target="Content" title="ListarS">Listar</a></li>
                                                                    <li><a href="<%=request.getContextPath()%>/ConsultarServicios.jsp" target="Content" title="ConsulatarS">Consultar</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="top">
                                                                <a href="#" class="top_link"><span>Factura</span></a>
                                                                <ul class="sub">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <table width="717" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="8" rowspan="2" align="left" valign="top"><img src="<%=request.getContextPath()%>/imagenes/footer_left.gif" alt="" width="8" height="56" /></td>
