...
<html>
    <head>
        ...
        <title>Page: Consultar Reserva</title>
...
<script type="text/javascript">
   JotForm.init(function(){
    ...
    <body>
        <form action="<%=CONTROLLER%>/Consultar/Reserva" method="post">
        ...
        <ul class="form-section">
            ...
            <table width="485" border="1" align="center">
                <tr>
                    ...
                    List lie = model.consultarreserva(codigo);
                        for(int ie2=0;ie2<lie.size();ie2++) {
                        mvc.model.Reserva s=(mvc.model.Reserva)lie.get(ie2);
                ...
                <tr>
                    ...
                    <td><font size="+1"><%=s.getNumero_Habitacion()%></font></td>
                    <td><font><a href="<%=request.getContextPath()%>/ModificarReserva.jsp?codigo=<%=s.getCodigo()%>">Modificar</a></font></td>
                </tr>
                <%}%>
                <% %>
            </table>
