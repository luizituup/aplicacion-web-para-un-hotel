			...
			$(function(){
				...
				$('#dialogImformacion').button().click(function(){
					...
					return false;
                                ...
                                // IniciarSesion 
                                $('#iniciarSesion').button().click(function(){
				});
                                            ...
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <div>
                                                        <ul class="menu">
                                                            <li class="top">
                                                                <a href="<%=request.getContextPath()%>/index.jsp" class="top_link"><span>Inicio</span></a>
                                                            </li>                                                           
                                                        </ul>
                                                    </div>
                                                </tr>
                                                                ...
                                                                <td align="left" valign="top">
                                                                    <table width="130" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td  align="left" valign="top">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <form id="Iniciar" method="post" action="<%=CONTROLLER%>/Iniciar/Session">
                                                                                    <tr>
                                                                                        <td height="20" align="left" valign="middle" class="highlight" style="text-transform:uppercase; font-size:10px;"><label><b>Login:</b></label></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td height="22" align="left" valign="middle"><label><b>Tipo:</b></label></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" valign="middle">
                                                                                            <select name="tipo" id="tipo" style="width: 115px">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td height="22" align="left" valign="middle"><label><b>Clave:</b></label></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" valign="middle"><input name="clave" type="password" class="input_box" id="clave" /></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="padding-top:9px;" align="center" valign="middle"><button id="iniciarSesion" class="ui-state-default ui-corner-all">Iniciar</button></td>
                                                                                    </tr>
                                                                                    </form>                                                                                    
                                                                                </table>
                                                                            </td>
                                                        ...
                                                        <table width="485" height="365" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td width="485" height="365" align="left" valign="top">
                                                                    <iframe src="<%=request.getContextPath()%>/ContenidoHotel.jsp" name="Content" frameborder="0" scrolling="no" width="485" height="650">
